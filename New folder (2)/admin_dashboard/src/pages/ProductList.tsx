...
// type SortAction = { type: SortActionType } | { type: 'SET_PRODUCTS'; payload: Product[] };
...
//   // Local sorting state using useReducer.
//   // Initialize with global products.
//   const [sortedProducts, dispatch] = useReducer(sortReducer, products);

//   // Update sortedProducts when global products change.
//   useEffect(() => {
//     dispatch({ type: 'SET_PRODUCTS', payload: products });
//     // Optionally, you can auto-sort on update:
